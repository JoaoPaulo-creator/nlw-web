    ...
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col intems-start justify-between overflow-hidden px-28 py-16 border-r border-white/10">
        ...
        <a href="" className="flex items-center gap-3 text-left hover:text-gray-50 transition-colors">
          ...
          <p className="text-sm leading-snugly max-w-[140px]"><span className="underline">Crie sua conta</span> e salve suas memórias!</p>
        </a>
        ...
        <div className="space-y-5">
          ...
          <div className="max-w-[420px] space-y-1">
            <h1 className="text-5l font-bold leading-tight text-gray-50">
